...
(
    ...
    `goods_id`    bigint(20)   NOT NULL DEFAULT '' COMMENT '商品',
    ...
    `update_time` datetime     NOT NULL DEFAULT '' COMMENT '更新时间',
    `create_user` varchar(32)  NOT NULL DEFAULT '' COMMENT '创建人',
    `update_user` varchar(32)  NOT NULL DEFAULT '' COMMENT '修改人',
...
(
    ...
    `address_book_id` bigint(20)     NOT NULL DEFAULT '' COMMENT '地址id',
    `order_time`      datetime       NOT NULL DEFAULT '' COMMENT '下单时间',
    `checkout_time`   datetime       NOT NULL DEFAULT '' COMMENT '结账时间',
    `pay_method`      int(1)         NOT NULL DEFAULT '1' COMMENT '支付方式 1微信,2支付宝',
    `amount`          decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '实收金额',
    `remark`          varchar(100)   NOT NULL DEFAULT '' DEFAULT NULL COMMENT '备注',
...
(
    ...
    `price`       decimal(10, 2) NOT NULL DEFAULT '' COMMENT '套餐价格',
...
(
    ...
    `price`       decimal(10, 2) NOT NULL DEFAULT '' COMMENT '商品原价（冗余字段）',
    `copies`      int(11)        NOT NULL DEFAULT 0.00 COMMENT '份数',
